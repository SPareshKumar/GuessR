...
const HintPanel = ({ isOpen, onClose, hintsRevealed, onReveal, targetWord }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 flex justify-end">
      <div className="bg-white w-72 h-full shadow-2xl border-l border-blue-100 p-6 animate-slide-in">
